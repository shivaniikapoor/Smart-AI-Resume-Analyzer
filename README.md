...
SmartHire is an AI-powered resume analyzer built with Python and Streamlit. It scores ATS compatibility, suggests improvements using NLP, helps build professional resumes with templates, shows job-market insights, and includes an admin panel for review and export.
